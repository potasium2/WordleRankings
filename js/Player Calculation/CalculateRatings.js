...
const jacob = new Player("Jacob", startingBase, "#90e040");

// Joined Day 2
const lilli = new Player("Lilli 🅱️", startingBase, "#f080f0");
const soul = new Player("Soul", startingBase, "#40d070");
...
const stano = new Player("Stanovacuum", startingBase, "#a00040", true);

// Joined Day 22-24
const potasium = new Player("Lifeline", startingBase, "#1040b0");
const crackbox = new Player("crackbox", startingBase, "#a0a0a0");
const mario = new Player("the plerg", startingBase, "#f05050");

// Joined Day 28
const creeper = new Player("Creeperman495", startingBase, "#40b040");
...
// Joined Day 71-76
const brix = new Player("Jack", startingBase, "#fceea0");
const kosa = new Player("K", startingBase, "#0b80a0");
...
// Joined Day 87
const fwogcarf = new Player("fwogcarf", startingBase, "#605080", true);

// Joined Day 93
const nick = new Player("Nicklas", startingBase, "#909090");

// Joined Day 111
const lightningE99  = new Player("LightningE99", startingBase, "#d03080");

// Joined Day 112
const kamil  = new Player("Kamil", startingBase, "#c0e020");

// Joined Day 124
const neverbacon  = new Player("Neverbacon", startingBase, "#e0c020", true);

// Joined Day 127
const studiedport  = new Player("worlds biggest Mariopython22 fan", startingBase, "#e05050");

// Joined Day 138
const iceNinja  = new Player("IceNinja", startingBase, "#10d0d0");
...
// Joined Day 144
const zapow  = new Player("𝘻𝘢𝘱𝘰𝘸 𝘣𝘢𝘺𝘭𝘪𝘦 ♡", startingBase, "#e06080");

// Joined Day 155
const david  = new Player("Toast", startingBase, "#4090d0");

// Joined Day 161-162
const adam  = new Player("e.b", startingBase, "#40a080");
const ward  = new Player("the_ward19", startingBase, "#e0d010");

// Joined Day 170
const zodile  = new Player("Dile", startingBase, "#40f0b0");
...
// Joined Day 224
const hive  = new Player("Hive", startingBase, "#3030e0");

// Joined Day 226
const mrekk  = new Player("mrekk", startingBase, "#e08010");
...
function SaveRankings(ratingSystemIteration) {
    ...
    if (ratingSystemIteration !== CURRENT_SYSTEM) {
        ...
        playersArr.forEach(player => {
            if (player.rating > 0) {
                if (player.timesPlayed < 15 && player.priorRanks.length > 60) {
                ...
                } else if (player.timesPlayed < 30 && player.priorRanks.length > 120) {
                    if (player.rating == player.priorRatings[player.priorRatings.length - 119]) {
                        player.SaveRankingInfo(playersArr.length);
                    } else {
                        rank++;
                ...
                } else if (player.priorRanks.length > 180) {
                    if (player.rating == player.priorRatings[player.priorRatings.length - 179]) {
                        player.SaveRankingInfo(playersArr.length);
                    } else {
                        rank++;
...
function CalculateRatings(ratingSystemIteration = CURRENT_SYSTEM) {
    ...
    lilli.DetermineRating(2, playerCount, 4, dailyDifficulty);
    soul.DetermineRating(2, playerCount, 4, dailyDifficulty);
    ...
    jacob.DetermineRating(1, playerCount, 2, dailyDifficulty);
    ...
    squiddy.DetermineRating(2, playerCount, 4, dailyDifficulty);
    aidan.DetermineRating(5, playerCount, 5, dailyDifficulty);
    stano.DetermineRating(6, playerCount, 6, dailyDifficulty);
    lucy.DetermineRating(7, playerCount, 7, dailyDifficulty);
    SaveRankings(ratingSystemIteration);
    ...
    rukir.DetermineRating(4, playerCount, 5, dailyDifficulty);
    aidan.DetermineRating(7, playerCount, 6, dailyDifficulty);
    april.DetermineRating(7, playerCount, 6, dailyDifficulty);
    creeper.DetermineRating(7, playerCount, 6, dailyDifficulty);
    izuna.DetermineRating(7, playerCount, 6, dailyDifficulty);
    ...
    lightning.DetermineRating(6, playerCount, 5, dailyDifficulty);
    creeper.DetermineRating(12, playerCount, 6, dailyDifficulty);
    ...
    brix.DetermineRating(0, playerCount, 2, dailyDifficulty, true); // Matte - Suspicious
    potasium.DetermineRating(1, playerCount, 3, dailyDifficulty);
    ...
    rukir.DetermineRating(10, playerCount, 6, dailyDifficulty);
    ...
    potasium.DetermineRating(6, playerCount, 4, dailyDifficulty);
    daphne.DetermineRating(11, playerCount, 5, dailyDifficulty);
    ...
    // Day 93: Wordle #1523
    nick.SetRating(baseRating);

    dailyDifficulty = 4.9;
    playerCount = 16;

    nick.DetermineRating(0, 0, 0, dailyDifficulty, true);
    aidan.DetermineRating(1, playerCount, 5, dailyDifficulty);
    april.DetermineRating(1, playerCount, 5, dailyDifficulty);
    creeper.DetermineRating(1, playerCount, 5, dailyDifficulty);
    daphne.DetermineRating(1, playerCount, 5, dailyDifficulty);
    nyfen.DetermineRating(1, playerCount, 5, dailyDifficulty);
    brix.DetermineRating(6, playerCount, 6, dailyDifficulty);
    jacob.DetermineRating(6, playerCount, 6, dailyDifficulty);
    khana.DetermineRating(6, playerCount, 6, dailyDifficulty);
    lucy.DetermineRating(6, playerCount, 6, dailyDifficulty);
    potasium.DetermineRating(6, playerCount, 6, dailyDifficulty);
    rukir.DetermineRating(6, playerCount, 6, dailyDifficulty);
    squiddy.DetermineRating(6, playerCount, 6, dailyDifficulty);
    stano.DetermineRating(6, playerCount, 6, dailyDifficulty);
    izuna.DetermineRating(14, playerCount, 7, dailyDifficulty);
    juanfan.DetermineRating(14, playerCount, 7, dailyDifficulty);
    lilli.DetermineRating(14, playerCount, 7, dailyDifficulty);
    SaveRankings(ratingSystemIteration);
    ...
    stano.DetermineRating(1, playerCount, 3, dailyDifficulty);
    izuna.DetermineRating(1, playerCount, 3, dailyDifficulty);
    brix.DetermineRating(5, playerCount, 4, dailyDifficulty);
    juanfan.DetermineRating(5, playerCount, 4, dailyDifficulty);
    lightning.DetermineRating(5, playerCount, 4, dailyDifficulty);
    april.DetermineRating(8, playerCount, 5, dailyDifficulty);
    aidan.DetermineRating(8, playerCount, 5, dailyDifficulty);
    ...
    izuna.DetermineRating(7, playerCount, 5, dailyDifficulty);
    juanfan.DetermineRating(7, playerCount, 5, dailyDifficulty);
    ...
    potasium.DetermineRating(1, playerCount, 3, dailyDifficulty);
    juanfan.DetermineRating(2, playerCount, 4, dailyDifficulty);
    brix.DetermineRating(3, playerCount, 5, dailyDifficulty);
    izuna.DetermineRating(3, playerCount, 5, dailyDifficulty);
    nyfen.DetermineRating(3, playerCount, 5, dailyDifficulty);
    panda.DetermineRating(3, playerCount, 5, dailyDifficulty);
    aidan.DetermineRating(7, playerCount, 6, dailyDifficulty);
    creeper.DetermineRating(7, playerCount, 6, dailyDifficulty);
    ...
    rukir.DetermineRating(9, playerCount, 6, dailyDifficulty);
    squiddy.DetermineRating(9, playerCount, 6, dailyDifficulty);
    stano.DetermineRating(9, playerCount, 6, dailyDifficulty);
    SaveRankings(ratingSystemIteration);

    // Day 100: Wordle #1530 - DAY 100 YIPPEE
    dailyDifficulty = 4.4;
    playerCount = 14;
    ...
    khana.DetermineRating(5, playerCount, 5, dailyDifficulty);
    nyfen.DetermineRating(5, playerCount, 5, dailyDifficulty);
    daphne.DetermineRating(10, playerCount, 6, dailyDifficulty);
    jacob.DetermineRating(10, playerCount, 6, dailyDifficulty);
    creeper.DetermineRating(12, playerCount, 7, dailyDifficulty);
    squiddy.DetermineRating(12, playerCount, 7, dailyDifficulty);
    stano.DetermineRating(12, playerCount, 7, dailyDifficulty);
    SaveRankings(ratingSystemIteration);
    ...
    aidan.DetermineRating(2, playerCount, 3, dailyDifficulty);
    juanfan.DetermineRating(2, playerCount, 3, dailyDifficulty);
    rukir.DetermineRating(2, playerCount, 3, dailyDifficulty);
    creeper.DetermineRating(5, playerCount, 4, dailyDifficulty);
    daphne.DetermineRating(5, playerCount, 4, dailyDifficulty);
    izuna.DetermineRating(5, playerCount, 4, dailyDifficulty);
    khana.DetermineRating(5, playerCount, 4, dailyDifficulty);
    lucy.DetermineRating(5, playerCount, 4, dailyDifficulty);
    nyfen.DetermineRating(5, playerCount, 4, dailyDifficulty);
    potasium.DetermineRating(5, playerCount, 4, dailyDifficulty);
    ...
    delta.DetermineRating(4, playerCount, 3, dailyDifficulty);
    ...
    aidan.DetermineRating(2, playerCount, 5, dailyDifficulty);
    creeper.DetermineRating(2, playerCount, 5, dailyDifficulty);
    daphne.DetermineRating(2, playerCount, 5, dailyDifficulty);
    juanfan.DetermineRating(2, playerCount, 5, dailyDifficulty);
    lightning.DetermineRating(2, playerCount, 5, dailyDifficulty);
    potasium.DetermineRating(2, playerCount, 5, dailyDifficulty);
    brix.DetermineRating(8, playerCount, 6, dailyDifficulty);
    delta.DetermineRating(8, playerCount, 6, dailyDifficulty);
    lucy.DetermineRating(8, playerCount, 6, dailyDifficulty);
    khana.DetermineRating(11, playerCount, 7, dailyDifficulty);
    nyfen.DetermineRating(11, playerCount, 7, dailyDifficulty);
    squiddy.DetermineRating(11, playerCount, 7, dailyDifficulty);
    SaveRankings(ratingSystemIteration);
    ...
    squiddy.DetermineRating(8, playerCount, 4, dailyDifficulty);
    SaveRankings(ratingSystemIteration);
    ...
    creeper.DetermineRating(6, playerCount, 4, dailyDifficulty);
    delta.DetermineRating(6, playerCount, 4, dailyDifficulty);
    ghostcowz.DetermineRating(6, playerCount, 4, dailyDifficulty);
    ...
    nyfen.DetermineRating(1, playerCount, 2, dailyDifficulty);
    brix.DetermineRating(3, playerCount, 3, dailyDifficulty);
    delta.DetermineRating(3, playerCount, 3, dailyDifficulty);
    izuna.DetermineRating(3, playerCount, 3, dailyDifficulty);
    juanfan.DetermineRating(3, playerCount, 3, dailyDifficulty);
    lucy.DetermineRating(3, playerCount, 3, dailyDifficulty);
    ...
    nyfen.DetermineRating(2, playerCount, 3, dailyDifficulty);
    potasium.DetermineRating(2, playerCount, 3, dailyDifficulty);
    aidan.DetermineRating(8, playerCount, 4, dailyDifficulty);
    lucy.DetermineRating(8, playerCount, 4, dailyDifficulty);
    squiddy.DetermineRating(8, playerCount, 4, dailyDifficulty);
    ...
    creeper.DetermineRating(1, playerCount, 2, dailyDifficulty);
    kamil.DetermineRating(1, playerCount, 2, dailyDifficulty);
    fwogcarf.DetermineRating(3, playerCount, 3, dailyDifficulty);
    juanfan.DetermineRating(3, playerCount, 3, dailyDifficulty);
    khana.DetermineRating(3, playerCount, 3, dailyDifficulty);
    lightning.DetermineRating(3, playerCount, 3, dailyDifficulty);
    potasium.DetermineRating(3, playerCount, 3, dailyDifficulty);
    squiddy.DetermineRating(3, playerCount, 3, dailyDifficulty);
    daphne.DetermineRating(9, playerCount, 4, dailyDifficulty);
    ...
    fwogcarf.DetermineRating(1, playerCount, 1, dailyDifficulty);
    creeper.DetermineRating(2, playerCount, 2, dailyDifficulty);
    nyfen.DetermineRating(2, playerCount, 2, dailyDifficulty);
    potasium.DetermineRating(2, playerCount, 2, dailyDifficulty);
    ...
    kamil.DetermineRating(1, playerCount, 2, dailyDifficulty);
    delta.DetermineRating(2, playerCount, 3, dailyDifficulty);
    fwogcarf.DetermineRating(2, playerCount, 3, dailyDifficulty);
    aidan.DetermineRating(4, playerCount, 4, dailyDifficulty);
    april.DetermineRating(4, playerCount, 4, dailyDifficulty);
    brix.DetermineRating(4, playerCount, 4, dailyDifficulty);
    khana.DetermineRating(4, playerCount, 4, dailyDifficulty);
    ...
    delta.DetermineRating(1, playerCount, 4, dailyDifficulty);
    juanfan.DetermineRating(1, playerCount, 4, dailyDifficulty);
    kamil.DetermineRating(1, playerCount, 4, dailyDifficulty);
    lotus.DetermineRating(1, playerCount, 4, dailyDifficulty);
    lucy.DetermineRating(1, playerCount, 4, dailyDifficulty);
    potasium.DetermineRating(1, playerCount, 4, dailyDifficulty);
    brix.DetermineRating(8, playerCount, 5, dailyDifficulty);
    daphne.DetermineRating(8, playerCount, 5, dailyDifficulty);
    ...
    lotus.DetermineRating(2, playerCount, 4, dailyDifficulty);
    nidgey.DetermineRating(2, playerCount, 4, dailyDifficulty);
    nyfen.DetermineRating(2, playerCount, 4, dailyDifficulty);
    april.DetermineRating(7, playerCount, 5, dailyDifficulty);
    daphne.DetermineRating(7, playerCount, 5, dailyDifficulty);
    ...
    zapow.SetRating(baseRating);

    lotus.DetermineRating(1, playerCount, 2, dailyDifficulty);
    aidan.DetermineRating(2, playerCount, 3, dailyDifficulty);
    skyler.DetermineRating(2, playerCount, 3, dailyDifficulty);
    creeper.DetermineRating(4, playerCount, 4, dailyDifficulty);
    delta.DetermineRating(4, playerCount, 4, dailyDifficulty);
    izuna.DetermineRating(4, playerCount, 4, dailyDifficulty);
    jacob.DetermineRating(4, playerCount, 4, dailyDifficulty);
    khana.DetermineRating(4, playerCount, 4, dailyDifficulty);
    lucy.DetermineRating(4, playerCount, 4, dailyDifficulty);
    nyfen.DetermineRating(4, playerCount, 4, dailyDifficulty);
    rukir.DetermineRating(4, playerCount, 4, dailyDifficulty);
    squiddy.DetermineRating(4, playerCount, 4, dailyDifficulty);
    april.DetermineRating(13, playerCount, 5, dailyDifficulty);
    brix.DetermineRating(13, playerCount, 5, dailyDifficulty);
    daphne.DetermineRating(13, playerCount, 5, dailyDifficulty);
    juanfan.DetermineRating(13, playerCount, 5, dailyDifficulty);
    kamil.DetermineRating(13, playerCount, 5, dailyDifficulty);
    potasium.DetermineRating(13, playerCount, 5, dailyDifficulty);
    zapow.DetermineRating(13, playerCount, 5, dailyDifficulty);
    lightning.DetermineRating(20, playerCount, 6, dailyDifficulty);
    SaveRankings(ratingSystemIteration);
    ...
    lucy.DetermineRating(1, playerCount, 3, dailyDifficulty);
    daphne.DetermineRating(3, playerCount, 4, dailyDifficulty);
    david.DetermineRating(3, playerCount, 4, dailyDifficulty);
    delta.DetermineRating(3, playerCount, 4, dailyDifficulty);
    fwogcarf.DetermineRating(3, playerCount, 4, dailyDifficulty);
    izuna.DetermineRating(3, playerCount, 4, dailyDifficulty);
    juanfan.DetermineRating(3, playerCount, 4, dailyDifficulty);
    ...
    nidgey.DetermineRating(13, playerCount, 6, dailyDifficulty);
    ...
    khana.DetermineRating(1, playerCount, 3, dailyDifficulty);
    ward.DetermineRating(1, playerCount, 3, dailyDifficulty);
    aidan.DetermineRating(3, playerCount, 4, dailyDifficulty);
    creeper.DetermineRating(3, playerCount, 4, dailyDifficulty);
    lucy.DetermineRating(3, playerCount, 4, dailyDifficulty);
    ...
    lightning.DetermineRating(1, playerCount, 2, dailyDifficulty);
    nyfen.DetermineRating(1, playerCount, 2, dailyDifficulty);
    april.DetermineRating(5, playerCount, 3, dailyDifficulty);
    brix.DetermineRating(5, playerCount, 3, dailyDifficulty);
    david.DetermineRating(5, playerCount, 3, dailyDifficulty);
    delta.DetermineRating(5, playerCount, 3, dailyDifficulty);
    nidgey.DetermineRating(5, playerCount, 3, dailyDifficulty);
    potasium.DetermineRating(5, playerCount, 3, dailyDifficulty);
    adam.DetermineRating(11, playerCount, 4, dailyDifficulty);
    aidan.DetermineRating(11, playerCount, 4, dailyDifficulty);
    khana.DetermineRating(11, playerCount, 4, dailyDifficulty);
    ...
    lotus.DetermineRating(1, playerCount, 2, dailyDifficulty);
    potasium.DetermineRating(1, playerCount, 2, dailyDifficulty);
    david.DetermineRating(3, playerCount, 3, dailyDifficulty);
    lucy.DetermineRating(3, playerCount, 3, dailyDifficulty);
    aidan.DetermineRating(5, playerCount, 4, dailyDifficulty);
    april.DetermineRating(5, playerCount, 4, dailyDifficulty);
    nyfen.DetermineRating(5, playerCount, 4, dailyDifficulty);
    ...
    april.DetermineRating(2, playerCount, 2, dailyDifficulty);
    david.DetermineRating(2, playerCount, 2, dailyDifficulty);
    juanfan.DetermineRating(2, playerCount, 2, dailyDifficulty);
    potasium.DetermineRating(2, playerCount, 2, dailyDifficulty);
    squiddy.DetermineRating(6, playerCount, 3, dailyDifficulty);
    creeper.DetermineRating(7, playerCount, 4, dailyDifficulty);
    ...
    nidgey.DetermineRating(3, playerCount, 2, dailyDifficulty);
    aidan.DetermineRating(4, playerCount, 3, dailyDifficulty);
    april.DetermineRating(4, playerCount, 3, dailyDifficulty);
    fwogcarf.DetermineRating(4, playerCount, 3, dailyDifficulty);
    lucy.DetermineRating(4, playerCount, 3, dailyDifficulty);
    nyfen.DetermineRating(4, playerCount, 3, dailyDifficulty);
    david.DetermineRating(9, playerCount, 4, dailyDifficulty);
    kamil.DetermineRating(9, playerCount, 4, dailyDifficulty);
    lightning.DetermineRating(9, playerCount, 4, dailyDifficulty);
    brix.DetermineRating(12, playerCount, 5, dailyDifficulty);
    juanfan.DetermineRating(12, playerCount, 5, dailyDifficulty);
    ...
    april.DetermineRating(2, playerCount, 4, dailyDifficulty);
    iceNinja.DetermineRating(2, playerCount, 4, dailyDifficulty);
    neverbacon.DetermineRating(2, playerCount, 4, dailyDifficulty);
    nidgey.DetermineRating(2, playerCount, 4, dailyDifficulty);
    squiddy.DetermineRating(2, playerCount, 4, dailyDifficulty);
    aidan.DetermineRating(7, playerCount, 5, dailyDifficulty);
    david.DetermineRating(7, playerCount, 5, dailyDifficulty);
    ...
    khana.DetermineRating(1, playerCount, 4, dailyDifficulty);
    lucy.DetermineRating(1, playerCount, 4, dailyDifficulty);
    nidgey.DetermineRating(1, playerCount, 4, dailyDifficulty);
    potasium.DetermineRating(1, playerCount, 4, dailyDifficulty);
    rukir.DetermineRating(1, playerCount, 4, dailyDifficulty);
    squiddy.DetermineRating(1, playerCount, 4, dailyDifficulty);
    aidan.DetermineRating(12, playerCount, 5, dailyDifficulty);
    ...
    potasium.DetermineRating(1, playerCount, 2, dailyDifficulty);
    creeper.DetermineRating(2, playerCount, 3, dailyDifficulty);
    jacob.DetermineRating(2, playerCount, 3, dailyDifficulty);
    lobsterfighter.DetermineRating(2, playerCount, 3, dailyDifficulty);
    neverbacon.DetermineRating(2, playerCount, 3, dailyDifficulty);
    aidan.DetermineRating(6, playerCount, 4, dailyDifficulty);
    april.DetermineRating(6, playerCount, 4, dailyDifficulty);
    brix.DetermineRating(6, playerCount, 4, dailyDifficulty);
    daphne.DetermineRating(6, playerCount, 4, dailyDifficulty);
    ...
    brix.DetermineRating(6, playerCount, 5, dailyDifficulty);
    lucy.DetermineRating(6, playerCount, 5, dailyDifficulty);
    neverbacon.DetermineRating(6, playerCount, 5, dailyDifficulty);
    fwogcarf.DetermineRating(10, playerCount, 6, dailyDifficulty);
    lightning.DetermineRating(10, playerCount, 6, dailyDifficulty);
    daphne.DetermineRating(12, playerCount, 7, dailyDifficulty);
    khana.DetermineRating(12, playerCount, 7, dailyDifficulty);
    skyler.DetermineRating(12, playerCount, 7, dailyDifficulty);
    SaveRankings(ratingSystemIteration);
    ...
    lucy.DetermineRating(1, playerCount, 2, dailyDifficulty);
    crackbox.DetermineRating(2, playerCount, 4, dailyDifficulty);
    juanfan.DetermineRating(2, playerCount, 4, dailyDifficulty);
    lightning.DetermineRating(2, playerCount, 4, dailyDifficulty);
    squiddy.DetermineRating(2, playerCount, 4, dailyDifficulty);
    aidan.DetermineRating(6, playerCount, 5, dailyDifficulty);
    ...
    skyler.DetermineRating(11, playerCount, 6, dailyDifficulty);
    brix.DetermineRating(13, playerCount, 7, dailyDifficulty);
    stano.DetermineRating(13, playerCount, 7, dailyDifficulty);
    SaveRankings(ratingSystemIteration);
    ...
    brix.DetermineRating(1, playerCount, 3, dailyDifficulty);
    fwogcarf.DetermineRating(1, playerCount, 3, dailyDifficulty);
    aidan.DetermineRating(3, playerCount, 4, dailyDifficulty);
    april.DetermineRating(3, playerCount, 4, dailyDifficulty);
    juanfan.DetermineRating(3, playerCount, 4, dailyDifficulty);
    khana.DetermineRating(3, playerCount, 4, dailyDifficulty);
    ...
    squiddy.DetermineRating(3, playerCount, 4, dailyDifficulty);
    daphne.DetermineRating(9, playerCount, 6, dailyDifficulty);
    iceNinja.DetermineRating(9, playerCount, 6, dailyDifficulty);
    kamil.DetermineRating(9, playerCount, 6, dailyDifficulty);
    SaveRankings(ratingSystemIteration);
    ...
    daphne.DetermineRating(2, playerCount, 4, dailyDifficulty);
    juanfan.DetermineRating(2, playerCount, 4, dailyDifficulty);
    skyler.DetermineRating(2, playerCount, 4, dailyDifficulty);
    squiddy.DetermineRating(2, playerCount, 4, dailyDifficulty);
    kamil.DetermineRating(7, playerCount, 6, dailyDifficulty);
    khana.DetermineRating(7, playerCount, 6, dailyDifficulty);
    april.DetermineRating(9, playerCount, 7, dailyDifficulty);
    ...
    aidan.DetermineRating(1, playerCount, 4, dailyDifficulty);
    ben.DetermineRating(2, playerCount, 5, dailyDifficulty);
    brix.DetermineRating(2, playerCount, 5, dailyDifficulty);
    khana.DetermineRating(2, playerCount, 5, dailyDifficulty);
    lucy.DetermineRating(2, playerCount, 5, dailyDifficulty);
    skyler.DetermineRating(2, playerCount, 5, dailyDifficulty);
    squiddy.DetermineRating(2, playerCount, 5, dailyDifficulty);
    april.DetermineRating(8, playerCount, 6, dailyDifficulty);
    daphne.DetermineRating(8, playerCount, 6, dailyDifficulty);
    stano.DetermineRating(8, playerCount, 6, dailyDifficulty);
    juanfan.DetermineRating(11, playerCount, 7, dailyDifficulty);
    SaveRankings(ratingSystemIteration);
    ...
    hive.SetRating(baseRating);

    creeper.DetermineRating(1, playerCount, 1, dailyDifficulty);
    aidan.DetermineRating(2, playerCount, 2, dailyDifficulty);
    juanfan.DetermineRating(2, playerCount, 2, dailyDifficulty);
    jacob.DetermineRating(4, playerCount, 3, dailyDifficulty);
    kamil.DetermineRating(4, playerCount, 3, dailyDifficulty);
    neverbacon.DetermineRating(4, playerCount, 3, dailyDifficulty);
    stano.DetermineRating(4, playerCount, 3, dailyDifficulty);
    april.DetermineRating(8, playerCount, 4, dailyDifficulty);
    fwogcarf.DetermineRating(8, playerCount, 4, dailyDifficulty);
    iceNinja.DetermineRating(8, playerCount, 4, dailyDifficulty);
    squiddy.DetermineRating(8, playerCount, 4, dailyDifficulty);
    brix.DetermineRating(12, playerCount, 5, dailyDifficulty);
    daphne.DetermineRating(12, playerCount, 5, dailyDifficulty);
    khana.DetermineRating(12, playerCount, 5, dailyDifficulty);
    lucy.DetermineRating(12, playerCount, 5, dailyDifficulty);
    skyler.DetermineRating(12, playerCount, 5, dailyDifficulty);
    hive.DetermineRating(17, playerCount, 6, dailyDifficulty);
    SaveRankings(ratingSystemIteration);
    ...
    squiddy.DetermineRating(7, playerCount, 5, dailyDifficulty);
    aidan.DetermineRating(10, playerCount, 6, dailyDifficulty);
    hive.DetermineRating(10, playerCount, 6, dailyDifficulty);
    SaveRankings(ratingSystemIteration);
    ...
    mrekk.SetRating(baseRating);

    lucy.DetermineRating(1, playerCount, 2, dailyDifficulty);
    iceNinja.DetermineRating(2, playerCount, 3, dailyDifficulty);
    juanfan.DetermineRating(2, playerCount, 3, dailyDifficulty);
    squiddy.DetermineRating(2, playerCount, 3, dailyDifficulty);
    stano.DetermineRating(2, playerCount, 3, dailyDifficulty);
    april.DetermineRating(6, playerCount, 4, dailyDifficulty);
    daphne.DetermineRating(6, playerCount, 4, dailyDifficulty);
    khana.DetermineRating(6, playerCount, 4, dailyDifficulty);
    lightning.DetermineRating(6, playerCount, 4, dailyDifficulty);
    mrekk.DetermineRating(6, playerCount, 4, dailyDifficulty);
    potasium.DetermineRating(6, playerCount, 4, dailyDifficulty);
    rukir.DetermineRating(6, playerCount, 4, dailyDifficulty);
    skyler.DetermineRating(6, playerCount, 4, dailyDifficulty);
    hive.DetermineRating(14, playerCount, 5, dailyDifficulty);
    ...
    mrekk.DetermineRating(1, playerCount, 3, dailyDifficulty);
    potasium.DetermineRating(1, playerCount, 3, dailyDifficulty);
    aidan.DetermineRating(3, playerCount, 4, dailyDifficulty);
    brix.DetermineRating(3, playerCount, 4, dailyDifficulty);
    khana.DetermineRating(3, playerCount, 4, dailyDifficulty);
    skyler.DetermineRating(3, playerCount, 4, dailyDifficulty);
    april.DetermineRating(7, playerCount, 5, dailyDifficulty);
    hive.DetermineRating(7, playerCount, 5, dailyDifficulty);
    iceNinja.DetermineRating(7, playerCount, 5, dailyDifficulty);
    juanfan.DetermineRating(7, playerCount, 5, dailyDifficulty);
    kamil.DetermineRating(7, playerCount, 5, dailyDifficulty);
    lightning.DetermineRating(7, playerCount, 5, dailyDifficulty);
    lucy.DetermineRating(7, playerCount, 5, dailyDifficulty);
    squiddy.DetermineRating(7, playerCount, 5, dailyDifficulty);
    stano.DetermineRating(15, playerCount, 6, dailyDifficulty);
    daphne.DetermineRating(16, playerCount, 7, dailyDifficulty);
    SaveRankings(ratingSystemIteration);
    ...
    april.DetermineRating(2, playerCount, 3, dailyDifficulty);
    khana.DetermineRating(2, playerCount, 3, dailyDifficulty);
    mrekk.DetermineRating(2, playerCount, 3, dailyDifficulty);
    potasium.DetermineRating(2, playerCount, 3, dailyDifficulty);
    aidan.DetermineRating(6, playerCount, 4, dailyDifficulty);
    brix.DetermineRating(6, playerCount, 4, dailyDifficulty);
    kamil.DetermineRating(6, playerCount, 4, dailyDifficulty);
    ...
    daphne.DetermineRating(12, playerCount, 6, dailyDifficulty);
    stano.DetermineRating(12, playerCount, 6, dailyDifficulty);
    hive.DetermineRating(14, playerCount, 7, dailyDifficulty);
    lightning.DetermineRating(14, playerCount, 7, dailyDifficulty);
    SaveRankings(ratingSystemIteration);
    ...
    hive.DetermineRating(11, playerCount, 5, dailyDifficulty);
    squiddy.DetermineRating(11, playerCount, 5, dailyDifficulty);
    mrekk.DetermineRating(15, playerCount, 6, dailyDifficulty);
    potasium.DetermineRating(15, playerCount, 6, dailyDifficulty);
    jacob.DetermineRating(17, playerCount, 7, dailyDifficulty);
    SaveRankings(ratingSystemIteration);
    ...
    khana.DetermineRating(1, playerCount, 3, dailyDifficulty);
    april.DetermineRating(7, playerCount, 4, dailyDifficulty);
    brix.DetermineRating(7, playerCount, 4, dailyDifficulty);
    juanfan.DetermineRating(7, playerCount, 4, dailyDifficulty);
    squiddy.DetermineRating(7, playerCount, 4, dailyDifficulty);
    stano.DetermineRating(7, playerCount, 4, dailyDifficulty);
    kamil.DetermineRating(12, playerCount, 5, dailyDifficulty);
    lightning.DetermineRating(12, playerCount, 5, dailyDifficulty);
    lightning.DetermineRating(12, playerCount, 5, dailyDifficulty);
    lucy.DetermineRating(12, playerCount, 5, dailyDifficulty);
    iceNinja.DetermineRating(16, playerCount, 6, dailyDifficulty);
    mrekk.DetermineRating(16, playerCount, 6, dailyDifficulty);
    potasium.DetermineRating(16, playerCount, 6, dailyDifficulty);
    skyler.DetermineRating(19, playerCount, 7, dailyDifficulty);
    SaveRankings(ratingSystemIteration);
    ...
    aidan.DetermineRating(2, playerCount, 4, dailyDifficulty);
    juanfan.DetermineRating(2, playerCount, 4, dailyDifficulty);
    mrekk.DetermineRating(2, playerCount, 4, dailyDifficulty);
    potasium.DetermineRating(2, playerCount, 4, dailyDifficulty);
    kamil.DetermineRating(6, playerCount, 5, dailyDifficulty);
    khana.DetermineRating(6, playerCount, 5, dailyDifficulty);
    skyler.DetermineRating(6, playerCount, 5, dailyDifficulty);
    ...
    creeper.DetermineRating(10, playerCount, 7, dailyDifficulty);
    daphne.DetermineRating(10, playerCount, 7, dailyDifficulty);
    hive.DetermineRating(10, playerCount, 7, dailyDifficulty);
    jacob.DetermineRating(10, playerCount, 7, dailyDifficulty);
    lightning.DetermineRating(10, playerCount, 7, dailyDifficulty);
    lucy.DetermineRating(10, playerCount, 7, dailyDifficulty);
    SaveRankings(ratingSystemIteration);
    ...
    daphne.DetermineRating(1, playerCount, 4, dailyDifficulty);
    hive.DetermineRating(1, playerCount, 4, dailyDifficulty);
    lucy.DetermineRating(1, playerCount, 4, dailyDifficulty);
    mrekk.DetermineRating(1, playerCount, 4, dailyDifficulty);
    potasium.DetermineRating(1, playerCount, 4, dailyDifficulty);
    rukir.DetermineRating(1, playerCount, 4, dailyDifficulty);
    brix.DetermineRating(7, playerCount, 5, dailyDifficulty);
    creeper.DetermineRating(7, playerCount, 5, dailyDifficulty);
    ...
    april.DetermineRating(14, playerCount, 6, dailyDifficulty);
    kamil.DetermineRating(14, playerCount, 6, dailyDifficulty);
    stano.DetermineRating(14, playerCount, 6, dailyDifficulty);
    aidan.DetermineRating(17, playerCount, 7, dailyDifficulty);
    juanfan.DetermineRating(17, playerCount, 7, dailyDifficulty);
    SaveRankings(ratingSystemIteration);
    ...
    creeper.DetermineRating(5, playerCount, 4, dailyDifficulty);
    daphne.DetermineRating(5, playerCount, 4, dailyDifficulty);
    hive.DetermineRating(5, playerCount, 4, dailyDifficulty);
    juanfan.DetermineRating(5, playerCount, 4, dailyDifficulty);
    kamil.DetermineRating(5, playerCount, 4, dailyDifficulty);
    mrekk.DetermineRating(5, playerCount, 4, dailyDifficulty);
    skyler.DetermineRating(5, playerCount, 4, dailyDifficulty);
    squiddy.DetermineRating(14, playerCount, 5, dailyDifficulty);
    fwogcarf.DetermineRating(15, playerCount, 6, dailyDifficulty);
    iceNinja.DetermineRating(16, playerCount, 7, dailyDifficulty);
    SaveRankings(ratingSystemIteration);
    ...
    squiddy.DetermineRating(5, playerCount, 4, dailyDifficulty);
    aidan.DetermineRating(15, playerCount, 5, dailyDifficulty);
    daphne.DetermineRating(15, playerCount, 5, dailyDifficulty);
    SaveRankings(ratingSystemIteration);
    ...
    squiddy.DetermineRating(1, playerCount, 3, dailyDifficulty);
    aidan.DetermineRating(6, playerCount, 4, dailyDifficulty);
    hive.DetermineRating(6, playerCount, 4, dailyDifficulty);
    kamil.DetermineRating(6, playerCount, 4, dailyDifficulty);
    khana.DetermineRating(6, playerCount, 4, dailyDifficulty);
    daphne.DetermineRating(10, playerCount, 5, dailyDifficulty);
    juanfan.DetermineRating(10, playerCount, 5, dailyDifficulty);
    ...
    april.DetermineRating(3, playerCount, 4, dailyDifficulty);
    daphne.DetermineRating(3, playerCount, 4, dailyDifficulty);
    hive.DetermineRating(3, playerCount, 4, dailyDifficulty);
    juanfan.DetermineRating(3, playerCount, 4, dailyDifficulty);
    kamil.DetermineRating(3, playerCount, 4, dailyDifficulty);
    lucy.DetermineRating(3, playerCount, 4, dailyDifficulty);
    rukir.DetermineRating(3, playerCount, 4, dailyDifficulty);
    iceNinja.DetermineRating(10, playerCount, 5, dailyDifficulty);
    khana.DetermineRating(10, playerCount, 5, dailyDifficulty);
    mrekk.DetermineRating(10, playerCount, 5, dailyDifficulty);
    skyler.DetermineRating(10, playerCount, 5, dailyDifficulty);
    squiddy.DetermineRating(10, playerCount, 5, dailyDifficulty);
    brix.DetermineRating(15, playerCount, 6, dailyDifficulty);
    SaveRankings(ratingSystemIteration);
    ...
    aidan.DetermineRating(6, playerCount, 5, dailyDifficulty);
    creeper.DetermineRating(6, playerCount, 5, dailyDifficulty);
    hive.DetermineRating(6, playerCount, 5, dailyDifficulty);
    juanfan.DetermineRating(6, playerCount, 5, dailyDifficulty);
    kamil.DetermineRating(6, playerCount, 5, dailyDifficulty);
    khana.DetermineRating(6, playerCount, 5, dailyDifficulty);
    april.DetermineRating(12, playerCount, 6, dailyDifficulty);
    ...
    jacob.DetermineRating(3, playerCount, 3, dailyDifficulty);
    lucy.DetermineRating(3, playerCount, 3, dailyDifficulty);
    mrekk.DetermineRating(3, playerCount, 3, dailyDifficulty);
    hive.DetermineRating(11, playerCount, 4, dailyDifficulty);
    iceNinja.DetermineRating(11, playerCount, 4, dailyDifficulty);
    kamil.DetermineRating(11, playerCount, 4, dailyDifficulty);
    khana.DetermineRating(11, playerCount, 4, dailyDifficulty);
    rukir.DetermineRating(11, playerCount, 4, dailyDifficulty);
    skyler.DetermineRating(16, playerCount, 5, dailyDifficulty);
    SaveRankings(ratingSystemIteration);
}
